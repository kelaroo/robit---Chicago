...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double HIGH_SPEED_COEFF = 0.9;

    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(3, 0.2, 0);
    ...
    public void powerFromAxis(double drive, double strafe, double rotate) {
        double RF = Range.clip(drive - strafe - rotate, -1, 1) * HIGH_SPEED_COEFF;
        double RB = Range.clip(drive + strafe - rotate, -1, 1) * HIGH_SPEED_COEFF;
        double LB = Range.clip(drive - strafe + rotate, -1, 1) * HIGH_SPEED_COEFF;
        double LF = Range.clip(drive + strafe + rotate, -1, 1) * HIGH_SPEED_COEFF;
