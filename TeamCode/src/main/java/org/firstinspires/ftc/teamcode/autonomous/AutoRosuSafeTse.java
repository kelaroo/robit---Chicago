...
@Config
@Autonomous
public class AutoRosuSafeTse extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (tsePosition) {
            case MID:
                t2 = drive.myTrajectoryBuilder(t1.end(), 40, 40)
                        .lineToLinearHeading(new Pose2d(T2_X_MID, T2_Y_MID, 0.0))
                        .build();
            ...
            case LEFT:
                t2 = drive.myTrajectoryBuilder(t1.end(), 40, 40)
                        .lineToLinearHeading(new Pose2d(T2_X_LEFT, T2_Y_LEFT, 0.0))
                        .build();
                t3 = drive.myTrajectoryBuilder(t2.end(), 40, 40)
                        .strafeLeft(T3_LEFT)
                        .build();
            ...
            default:
                t2 = drive.myTrajectoryBuilder(t1.end(), 40, 40)
                        .lineToLinearHeading(new Pose2d(T2_X_RIGHT, T2_Y_RIGHT, 0.0))
                        .build();
                t3 = drive.myTrajectoryBuilder(t2.end(), 40, 40)
                        .strafeLeft(T3_RIGHT)
                        .build();
        ...
        Trajectory t4 = drive.trajectoryBuilder(t3.end())
                .lineToLinearHeading(new Pose2d(T4_X, T4_Y, rad(0.0)))
                .build();
